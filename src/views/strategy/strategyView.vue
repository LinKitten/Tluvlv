        ...
        <div class="local_con_left_sousuo">
          <ul>
            ...
            <li
              ...
              :key="index"
               :class="index==row ? 'change_local_con_left_sousuo_li' : 'unchange_local_con_left_sousuo_li'"
...
export default {
    data(){
        return{
            ...
            articles:[{
                id:1,
                abs:"第一篇旅游攻略",
                cover:"http://localhost:8081/image/strategy/1.jpeg",
                place:"广州",
                watch:187,
                price:1000,
                title:"白云之巅"
                ...
                id:2,
                abs:"第二篇旅游攻略",
                cover:"http://localhost:8081/image/strategy/2.jpeg",
                place:"揭阳",
                watch:235,
                price:999,
                title:"揭阳--古城吃路"
            ...
            hotsells:[
                ...
                title:"热卖现场",
                price:1000,
                img:"http://localhost:8081/image/home/4.jpg"
                }
            ]
        }
    },
    ...
    mounted(){//在组件加载后生效 钩子函数
        //发送请求
        this.postRequest('/selectStrategyAll').then(res=>{
