      ...
      comments: [
        {
          ...
          user: {
            ...
            username: "linlinlin",
            headImg:
              "http://localhost:8081/image/user/ab60a7d1aafe49a69128bc6f4fb7875a.jpeg",
          },
          showInput: false, //控制删除按钮和修改按钮的显示和隐藏
        },
      ],
      //文章内容
      article: {
  ...
  methods: {
    ...
    queryDiaryById(id) {
      this.postRequest("/queryDiaryById?id=" + id)
        .then((success) => {
          console.log("成功的数据：" + success.data);
          //将查询到的文章信息赋值给article，随后通过vue进行数据渲染
