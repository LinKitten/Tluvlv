<template>
  <div id="navbar">
    ...
    <el-dialog title="修改用户信息" :visible.sync="dialogVisible" width="30%" :before-close="handleClose">
      <!-- action发送请求 -->
      <el-upload action="/uploadUserImg" :show-file-list="false" :on-success="uploadSuccess" :on-error="uploadError"
        :data="this.user" :before-upload="beforeAvatarUpload">
        <el-image style="width: 200px; height: 200px;border-radius: 100%;margin-bottom:2%;" :src="user.headImg"
          :fit="fill">
        </el-image>
      </el-upload>

      <el-input v-model="user.username" placeholder="请输入用户名" class="username"></el-input>
      <el-input v-model="user.password" placeholder="请输入密码"></el-input>
      <span slot="footer" class="dialog-footer">
        <el-button @click="dialogVisible = false">取 消</el-button>
        <el-button type="primary" @click="update_click">修改</el-button>
      </span>
    </el-dialog>
    ...
    <div class="lww_header">
      <div class="header_wrap">
        ...
        <div class="login_info">
          ...
          <a href="javascript:;">
            <img :src="user.headImg" id="login_user_headUrl" @click="dialogVisible = true" />
          </a>
          <a href="javascript:;" title="退出登录" rel="nofollow" id="logoutbtn">退出登录</a>
        </div>
      </div>
    </div>
  </div>
